export default function Hero() {
    return (<div className=" w-full max-w-7xl lg:px-8 ">
                    ...
                    <div className="max-w-2xl"><h1
                        ...
                        <div className="top-[var(--avatar-top,theme(spacing.3))] w-full">
                            <div className="relative">
                                ...
                                <a aria-label="Home" className="block h-16 w-16 origin-left pointer-events-auto"></a>
                            </div>
                        </div><p
                        className="mt-6 text-base text-zinc-600 dark:text-zinc-400">I’m Spencer, a software designer and
